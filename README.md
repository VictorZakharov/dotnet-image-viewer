...
### Other
- **Task manager...** opens a live monitor for this ImageViewer process with CPU, working-set/private/managed memory, thread count, uptime, and rolling five-minute session history for CPU and memory; its persistent toolbar option replaces the button with a compact, clickable live CPU graph
